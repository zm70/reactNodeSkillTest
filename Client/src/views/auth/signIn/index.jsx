  ...
  const login = async () => {
    ...
    try {
      ...
      if (response && response.status === 200) {
        ...
        toast.error(response.response?.data?.error || "Login failed. Please try again.");
      }
    } catch (e) {
      ...
      >
        <Box me="auto">
          ...
          <Text
            ...
            fontSize="md"
          >
            To sign in, please connect your wallet first, then enter your email and password.
          </Text>
        </Box>
        <Flex
          zIndex="2"
        ...
        >
        <Flex mb="24px" alignItems="center" gap="2">
          {walletAddress ? (
